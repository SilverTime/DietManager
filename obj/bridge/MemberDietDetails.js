//Diet/MemberDietDetails
/**
 * 会员食谱详情
 * 各个食材中确定具体的餐次，默认为正餐，可选 加餐，训练前
 * @package Diet\Object
 */
define('MemberDietDetails',
    ['avalon'],
    function () {
        var obj={      
            /**
...
gets: function (DetailIDs,success,error) {
                ...
                $$.call({
                    i:"Diet/MemberDietDetails/gets",
                    data:{
                        "Diet/MemberDietDetails":DetailIDs,
                        "P":1,
                        "N":1000000
                    },
                    success:configFn.success,
...
search: function (data,success,error) {
                ...
                $$.call({
                    i:"Diet/MemberDietDetails/search",
                    data:data,
                    success:configFn.success,
                    error:configFn.error
                })
...
add: function (data,success,error) {
        ...
        return window['obj_Diet_MemberDietDetails']=obj
    })