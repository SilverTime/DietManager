...
define('FoodManage', [
    'avalon',
    'text!../../package/FoodManage/FoodManage.html',
    'css!../../package/FoodManage/FoodManage.css',
    '../../lib/pager/pager',
    ...
    var vm = avalon.define({
        ...
        ready: function (i) {
            ...
            vm.$watch('Keyword', function () {
                ...
                vm.timeout = setTimeout(function () {
                    goto("#!/FoodManage/"+[1,vm.Keyword].join('&&'))
                }, 300)
            })
        ...
        $paper: {
            ...
            showPage: 6,
            getList: function (p) {
                goto("#!/FoodManage/"+[p,vm.Keyword].join('&&'))
            }
        },
        ...
        add:function(){
            require(['../../package/FoodManage/EditFood'], function (that) {
                that.ready()
            })
        },
        edit: function (index) {
